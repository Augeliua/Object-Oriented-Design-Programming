...
public Enquiry submitEnquiry(Project project, String message, EnquiryRepository /*currently missing*/ enquiryRepo) {
...
public void submitApplication(Project project, FlatType flatType, ApplicationRepository /*currently missing*/ appRepo, ProjectRepository projectRepo) {
	...
	Application application = new Application(applicationId, this, project, applicationDate.toString(), flatType);
	
	// No need to call application.submit(); anymore — status is automatically set to PENDING in constructor
